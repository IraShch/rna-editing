...
def test_model(model, X, y, model_name):
    ...
    output_file_name = '/Users/bioinformaticshub/Documents/Ira/soft/neural_net/' + model_name + "_test.tsv"
...
def train_test(X_train, X_validate, X_test, y_train, y_validate, y_test):
    ...
    # test
    output_dir = '/Users/bioinformaticshub/Documents/Ira/soft/neural_net/plots/test_50_BT20/'
    show_learning_history(history, save=True, fname=output_dir + '50nodes_learning_BT20')
    test_model(model, X_test, y_test, "50nodes_BT20")
...
def main():
    ...
    train_test(X_train, X_validate, X_test, y_train, y_validate, y_test)
    # learning_rate_tune(X_train, y_train, X_validate, y_validate)

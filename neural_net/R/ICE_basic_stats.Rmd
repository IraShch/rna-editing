...
if (params$stability == "False") {
  file_name <- paste0(params$results_dir, "/", params$model_name, "/", params$dir, "/ADAR_fractions.tsv")
} else {
  file_name <- paste0(params$dir, "/", params$model_name, "_", params$model_name, "_adar", params$stability, "_denoised_ADAR_fractions.tsv")
}
